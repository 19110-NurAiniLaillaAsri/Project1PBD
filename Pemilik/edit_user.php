...
$getID = $_GET['getId'];
$sqlUser = "SELECT * FROM user WHERE IdUser = '$getID'";
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group mt-2">
                                ...
                                <input type="text" name="IdUser" class="form-control" value="<?php echo $row['IdUser']?>">
                            </div>
                            <div class="form-group mt-2">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <select class="form-select" id="validationCustom04" name="HakAkses" required value="<?php echo $row['HakAkses']?>">
                                    <option <?php if ($row['HakAkses'] == "Pemilik") {echo 'selected';}?> value="Pemilik">Pemilik</option>
                                    <option <?php if ($row['HakAkses'] == "Teller") {echo 'selected';}?> value="Teller">Teller</option>
                                    <option <?php if ($row['HakAkses'] == "Teknisi") {echo 'selected';}?> value="Teknisi">Teknisi</option>
                                    <option <?php if ($row['HakAkses'] == "Customer") {echo 'selected';}?> value="Customer">Customer</option>
                                </select>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mt-3" name="updateUser" style="width: 25%;">Update</button>
                            </div>
                        </form>
                    </div>
                </div>

<?php
require 'function/kelola_transaksi2.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    		...
    		<div class="container-fluid mt-2">
                <div class="card">
                    <div class="card-header">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="transaksi.php">Galeri Motor</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="true" href="transaksi2.php">Data Transaksi</a>
                        </li>
                        </ul>
                    </div>
                    <div class="card-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 160px;">
                                                        ...
                                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?php echo $row['IdTrsk'] ?>"><i class="far fa-edit"></i></button>
...
<!-- Modal Edit Transaksi -->
                                                    <form method="POST" class="form-group">
                                                        <div class="modal fade text-start" id="edit<?php echo $row['IdTrsk'] ?>" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="text-center mb-3">
                                                                            <img src="../Gambar_Motor/<?php echo $row['Gambar_Motor'] ?>" style="height: 150px;">
                                                                        </div>
                                                                        <div class="row pb-3">
                                                                            <div class="col-5 mt-1"><label>Tanggal Transaksi</label></div>
                                                                            <div class="col">
                                                                        ...
                                                                        <div class="row pb-3">
                                                                            <div class="col-5 mt-1"><label>ID Kendaraan</label></div>
                                                                            <div class="col">
                                                                                <input type="text" class="form-control form-box" value="<?php echo $row['Id_Kendaraan'] ?>" readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row pb-3">
                                                                            <div class="col-5 mt-1"><label>Harga Jual</label></div>
                                                                        ...
                                                                        <div class="row pb-3">
                                                                            <div class="col-5 mt-1"><label>Harga Jual Real</label></div>
                                                                            <div class="col">
                                                                                <input type="text" class="form-control form-box" value="<?php echo $row['Harga_Jual_Real']?>" readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">  
                                                                            <div class="col-md-12 d-flex justify-content-end">
                                                                                <button type="submit" class="btn btn-primary" name="editTransaksi">Simpan</button>
                                                                            </div>                                     
                                                                        </div>   
                                                                    </div>
                                                                </div>
